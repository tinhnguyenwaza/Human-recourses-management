...
public class HumanResources {
	...
	public static  void main(String[] args) {
		...
		do {
			...
			System.out.println("\n - Nhập bộ phận công ty ");
			System.out.print("chọn 1 để nhập danh sách bộ phân -- chọn 0 để kết thức nhận bộ phận: ");
		...
		do {
			...
			case 6: // tìm kiếm nhân viên theo bộ phận
				...
				String chonBoPhan2 = bophan.get(soChon).getTenBoPhan();
				
				for (int i = 0; i < nv.size(); i++) {

					if (nv.get(i).getBoPhan().equalsIgnoreCase(chonBoPhan2)) {
						nv.get(i).display();
					} else {
					System.out.println(" ");
				}
